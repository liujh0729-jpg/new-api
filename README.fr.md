...
> [!TIP]
> **Dernière image ACR :** `crpi-3iiuxr617jsmyl60.cn-hangzhou.personal.cr.aliyuncs.com/aipdd/ap-new-api-community:latest`
> **Image PostgreSQL :** `crpi-3iiuxr617jsmyl60.cn-hangzhou.personal.cr.aliyuncs.com/aipdd/postgres:15`
> **Image Redis :** `crpi-3iiuxr617jsmyl60.cn-hangzhou.personal.cr.aliyuncs.com/aipdd/redis:latest`
> **Tirage ACR :** `docker pull crpi-3iiuxr617jsmyl60.cn-hangzhou.personal.cr.aliyuncs.com/aipdd/ap-new-api-community:latest`
...
Pour les paramètres et exemples de requête des modèles AIPDD, consultez la [spécification OpenAPI publique](docs/openapi/public.json).
...
```bash
# Se connecter à ACR et tirer la dernière image AIPDD
