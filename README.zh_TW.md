...
> [!TIP]
> **最新版 ACR 鏡像：** `crpi-3iiuxr617jsmyl60.cn-hangzhou.personal.cr.aliyuncs.com/aipdd/ap-new-api-community:latest`
...
AIPDD 模型調用參數與請求範例請參考 [公開 OpenAPI 契約](docs/openapi/public.json)。
