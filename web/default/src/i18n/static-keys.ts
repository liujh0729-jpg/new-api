...
export const STATIC_I18N_KEYS = [
  ...
  // Test Bench dynamic model labels and field metadata
  'DeepSeek standard LLM',
  'Doubao Seedream image generation',
  'Doubao Seedance 2.0 video generation',
  'Doubao Seedance 1.5 video generation',
  'AIPDD Flux image-to-image',
  'AIPDD Flux text-to-image',
  'AIPDD Wan2.2 image-to-video',
  'AIPDD Wan2.2 subject replacement',
  ...
  'video and prompt are required; image is optional.',
  'Motion reference video and target subject image are required.',
  'The LoadAudio field must keep its exact capitalization.',
  'input/text and reference audio are required.',
  'Per second',
  'System prompt',
  'User message',
  'temperature',
  ...
  'This MiniMax H3 model does not use a prompt',
  'This MiniMax H3 model requires a prompt',
  'MiniMax H3 does not support video references',
  'MiniMax H3 requires {{min}}–{{max}} image references for this model',
  'MiniMax H3 requires {{min}}–{{max}} audio references for this model',
  'MiniMax H3 requires both first and last frames',
  'This aspect ratio is not supported by the MiniMax H3 model',
  'This resolution is not supported by the MiniMax H3 model',
  'MiniMax H3 duration must be an integer from {{min}} to {{max}} seconds',
  'MiniMax H3 reference media must use a public HTTP(S) URL',
  'Upload image',
  'Upload load_video',
  'Upload motion_video',
  'Upload appearance_image',
  'Upload video',
  'Upload LoadAudio',
  'Upload audio',
  'Upload emotion_audio',
  'Upload file',
  ...
  'Polling limit',
  'Polling limit must be a positive integer',
  'Maximum automatic polling attempts. Each attempt waits 5 seconds.',
  'No previewable result URL found in the task response.',
  'ready',
  'checking',
  'connected',
  'failed',
  ...
  'API Keys are loaded from your account.',
  'From environment variable',
  'API Key',
  'Loading API keys...',
  'Loading selected API key...',
  'Selected API key will be loaded before requests.',
  'No enabled API keys found',
  'No enabled API keys found. Create one first.',
  'Select API Key',
  'Selected API Key IDs are saved locally.',
  'Please select an API Key first',
  'Copy code',
  'Request code',
  'Python request code',
  'Java request code',
  'Node.js request code',
  'Python request code copied',
  'Java request code copied',
  'Node.js request code copied',
  'Loading models...',
  '{{count}} account models loaded',
  '{{count}} built-in test templates',
  'Could not load account models. Built-in templates are shown.',

  // Seedance administration statuses
  'seedance.status.active',
  'seedance.status.disabled',
  'seedance.status.pending',
  'seedance.status.retiring',
  'seedance.status.retired',
  'seedance.status.orderReceived',
  'seedance.status.generationSubmitting',
  'seedance.status.generationProcessing',
  'seedance.status.enhancing',
  'seedance.status.succeeded',
  'seedance.status.failed',
  'seedance.status.cancelled',
  'seedance.status.running',
  'seedance.status.submissionOutcomeUnknown',
  'seedance.status.ready',
  'seedance.status.sending',
  'seedance.status.synced',
  'seedance.status.retryWait',
  'seedance.status.deadLetter',
  'seedance.status.authPaused',
  'seedance.status.none',
  'seedance.status.waiting',
  'seedance.status.delivered',
  'seedance.status.estimated',
  'seedance.status.partial',
  'seedance.status.confirmed',
  'seedance.status.reconciliationRequired',
  'seedance.status.allocated',
  'seedance.status.reconciliationOpen',
  'seedance.status.resolved',
  'seedance.status.idle',
  'seedance.status.syncing',
  'seedance.status.notConfigured',
  'seedance.status.notReady',
  'seedance.status.pendingValidation',
  'seedance.status.unknown',
  'seedance.configuration.siteId',
  'seedance.configuration.siteIdManagedHelp',
  'seedance.configuration.siteIdManualHelp',
  'seedance.configuration.siteIdMismatchHelp',
  ...
  'Upgrade Group',
  'Regenerate',
  'Reference audio total duration must be 15 seconds or shorter',
  'Reference media must be uploaded before video generation. Please reselect the files and try again.',
  'Reference video total duration must be 15 seconds or shorter',
  'Reference videos must be 15 seconds or shorter',
