...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		financeRoute.Use(middleware.AdminAuth())
		{
			...
			financeRoute.POST("/sync/outbox/:id/close", controller.AdminCloseAIPDDFinanceOutbox)
			financeRoute.POST("/sync/orphans/close", controller.AdminCloseOrphanAIPDDFinanceOutbox)
			financeRoute.POST("/sync/poison/skip", controller.AdminSkipAIPDDFinancePoisonEvent)
		...
		virtualCharacterRoute.Use(middleware.TokenOrUserAuth())
		{
			...
			virtualCharacterRoute.POST("/:id/assets", middleware.UserUploadRateLimit(), controller.UploadVirtualCharacterAsset)
			virtualCharacterRoute.GET("/:id/assets/:asset_id/preview", controller.PreviewVirtualCharacterAsset)
			virtualCharacterRoute.PUT("/:id/assets/:asset_id/primary", controller.SetVirtualCharacterPrimaryAsset)
			virtualCharacterRoute.DELETE("/:id/assets/:asset_id", controller.DeleteVirtualCharacterAsset)
			virtualCharacterRoute.GET("/:id/preview", controller.VirtualCharacterGone)
